(function() {
  ...
  SenderCtrl = function($scope, Mandrill) {
    ...
    $scope.sermon = [
      {
        ...
        month: 'October 2014',
        name: 'Marriage',
        lesson: ["10/5/2014 , 8AM , Understanding the Gospel of Grace PT II", "10/6/2014 , 10AM , Understanding the Gospel of Grace PT II"],
        live: true
      }
    ];
    $scope.setup = {
    ...
    this.constructMessage = function(sender) {
      ...
      return "<h2>Hello.</h2>    <p>I just got sent from the Mandrill angular proof of concept    at <a href='http://www.github.com'>www.github.com</a>.</p>    <h3>Info:</h3>    <ul>      <li>Genre: " + sender.selectedGenre + "</li>      <li>Name: " + sender.name + "</li>      <li>Email: " + sender.email + "</li>      <li>Phone: " + sender.phone + "</li>    </ul>    <h3>How awesome am I?</h3>    <p>" + sender.awesome + "</p>    <h3>Who do I like?</h3>     <p>" + peopleILike + "</p>    <h3>Anything Else?</h3>    <p>" + sender.randomtext + "</p>";
    };
